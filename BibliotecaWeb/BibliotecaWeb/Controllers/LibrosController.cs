...
namespace BibliotecaWeb.Controllers
{
    public class LibrosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDLibro,ISBN,Nombre,Autor,Editorial,Fecha")] Libros libros)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDLibro,ISBN,Nombre,Autor,Editorial,Fecha")] Libros libros)
        {
            if (ModelState.IsValid)
            {
